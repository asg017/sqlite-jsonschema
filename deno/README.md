...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-jsonschema@0.2.2-alpha.2/mod.ts)
...
import * as sqlite_jsonschema from  "https://deno.land/x/sqlite-jsonschema@0.2.2-alpha.2/mod.ts";
...
`x/sqlite-jsonschema` does not work with [`x/sqlite`](https://deno.land/x/sqlite@v3.7.0), which is a WASM-based Deno SQLite module that does not support loading extensions.
